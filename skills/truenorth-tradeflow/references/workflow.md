...
- **Customize** is treated as a watcher entry point, not an order-editing safe action. **Start watching** transitions to `NOT_EXECUTED` unless a separately scoped watcher feature exists.
